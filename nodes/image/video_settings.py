...
class LoadVideoSettings(TiNode):
	...
	# Wildcard for the same reason as Match Source Format: these drive COMBO
	# widget inputs, which a STRING output cannot connect to.
	RETURN_TYPES = (ANY, "INT", ANY, ANY, ANY)
